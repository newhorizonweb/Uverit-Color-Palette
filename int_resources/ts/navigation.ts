...
const fiIcon: string = "<svg xmlns='http://www.w3.org/2000/svg' xml:space='preserve' id='Layer_2' x='0' y='0' style='enable-background:new 0 0 400 400' version='1.1' viewBox='0 0 400 400'><path d='M338 325V125H138v-13c0-20 16-37 37-37h37V0h-37C113 0 63 50 63 113v12H13v75h50v125H13v75h175v-75h-50V200h125v125h-50v75h175v-75h-50z' class='st0'/><circle cx='300' cy='37.5' r='37.5' class='st0'/></svg>";

const navArrowIcon: string = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 426.3 255.4' xmlns:v='https://vecta.io/nano'><path d='M414 12.2l-.3-.2a43.13 43.13 0 0 0-29.4-12C373-.1 362.1 4.4 354 12.4L213.6 153.6h0 0 0L73.2 12.4C65.1 4.4 54.2-.1 42.9 0a43.13 43.13 0 0 0-29.4 12l-.3.2C-3.3 29-3.1 56 13.5 72.6l170.7 170.6c8.2 8 18.8 12.1 29.3 12.2h.1 0 0 0c10.6-.1 21.2-4.2 29.4-12.2L413.7 72.6c16.6-16.6 16.8-43.6.3-60.4z'/></svg>";
...
const paletteVersion:string = "v2.0.0";
